	...
	<nav class="navbar navbar-default" role="navigation">
		<div class="container">
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand logo" href="/shop/Home"><img width="80px" src="/shop/image/logo/logo.png" alt=""></a>
			</div>
			...
			<div class="collapse navbar-collapse navbar-ex1-collapse">
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li class="action giohang">
					 <a href="/shop/Home/Cart">Giỏ hàng<i class="icon cart fas fa-shopping-cart"></i><span class="quantity" id="sl"><?php echo $quantity ?></span></a></li>
